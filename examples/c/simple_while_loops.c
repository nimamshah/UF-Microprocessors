/*//////////////////////////////////////////////////////////////////////////////////
 * simple_while_loops.c
 *
 *  Modified: 28 Oct 2015
 *  Author:  Dr. Schwartz, Daniel Frank and Josh Weaver
 *  Purpose: To provide a simple example for while loops.  While loop version of the 
 *           simple if statements example.  Read PortF and check bit 7.  If it is
 *           high, it will turn on PortQ's on-board LEDs.  If it is low, it will turn
 *           them off.
 *           
...
int main(void)
{
    ...
    while(1)
    {
        while(PORTF_IN == 0x80) // check to see if bit 7 on PortF is high
        {
