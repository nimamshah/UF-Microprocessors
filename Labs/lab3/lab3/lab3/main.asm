 ...
 * Description: The purpose of this program is to use EBI and expansion ports to read input and conditionally control output.
 */
...
STORE:
	...
	ldi r17, 8				;# of iterations for each rotation
	sbrc r16, 0				;check even or odd
	rjmp ODD
...
EVEN:
	...
	lsl r16					;shift left
	adc r16, r18			;if carry got a bit, it'll be put into bit 0 here
	st X, r16				;output to OutPort
	dec r17
	breq LOAD
	rjmp EVEN
